...
const cloudIcon = (props) => {
  return(
    <svg name="UploadImageBtn" onClick={props.clicked} version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 44 44" xmlnsXlink="http://www.w3.org/1999/xlink" className={classes.CloudIcon}>
